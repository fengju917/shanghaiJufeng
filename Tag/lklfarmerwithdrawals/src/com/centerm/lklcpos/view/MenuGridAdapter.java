...
public class MenuGridAdapter extends BaseAdapter {
	...
	public MenuGridAdapter(Context context, List<Shortcut> data) {
		super();
		this.context = context;
		this.data = data;
	}

	public MenuGridAdapter(Context context, List<Shortcut> data, boolean hasText) {
		super();
		this.context = context;
		this.data = data;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ImageView iconImageView = (ImageView) convertView.findViewById(R.id.grid_item_icon);
