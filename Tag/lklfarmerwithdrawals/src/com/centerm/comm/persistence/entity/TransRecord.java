package com.centerm.comm.persistence.entity;
...
public class TransRecord {
	...
	public String batchbillno; // 批次号票据号(凭证号)
	...
	public String reserve1; // 预留信息1，交易应答的消息类型；
	public String reserve2; // 预留信息2, 附加响应数据
	public String reserve3; // 预留信息3, CT、AAC、ARPC上送报文中F55
